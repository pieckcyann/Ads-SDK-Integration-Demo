...
//                    }
    ...
    private static String extractTemplateParamValue(String str, String key) {
        if (str == null || key == null || key.isEmpty()) return null;
